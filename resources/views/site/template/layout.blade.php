...
<html lang="pt-br">
    <head>
        <title>{{ $title ?? 'Faça sua reserva'}}</title>
        <meta charset="UTF-8">
        ...
        <!--Responsive-->
        <link rel="stylesheet" href="{{ asset(mix('css/responsive.css')) }}">
        ...
        <nav class="navbar navbar-expand-lg navbar-light menu">
            <div class="container">
                ...
                <a class="navbar-brand" href="?pg=home">
                    <img src="{{ asset('images/logo.png') }}" alt="" class="img-menu">
                </a>
                    ...
                    <div class="main-user-auth">
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle user-auth" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{ asset('images/no-image.png') }}" alt="" class="img-header-user">
                                {{ auth()->user()->name}}
                            </a>
